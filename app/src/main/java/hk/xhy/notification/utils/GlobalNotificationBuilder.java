...
public final class GlobalNotificationBuilder {
    ...
    private static HashMap<Integer, NotificationCompat.Builder> map = new HashMap<>();
    ...
    public static void setNotificationCompatBuilderInstance(int notificationId, NotificationCompat.Builder builder) {
        map.put(notificationId, builder);
    }

    public static NotificationCompat.Builder getNotificationCompatBuilderInstance(int notificationId) {
